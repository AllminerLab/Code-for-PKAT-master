...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    model = PKAT(data_config=config, pretrain_data=pretrain_data, args=args)
    ...
    *********************************************************
    ...
    if args.save_flag == 1:
        ...
        save_saver = tf.train.Saver(max_to_keep=1)  #保存最后一代的模型
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            if args.report != 1:
                ...
                if args.save_flag == -2:
                    ...
                    print('save the weights of pkat in path: ', temp_save_path)
                    exit()
    ...
    *********************************************************
    ...
    for epoch in range(args.epoch):
        ...
        if (epoch + 1) % show_step != 0:
            if args.verbose > 0 and epoch % args.verbose == 0:   #verbose=50
