...
def create_initializer(initializer_range=0.02):
    ...
    return tf.truncated_normal_initializer(stddev=initializer_range)  # tf.constant_initializer可以设置初始化
    # item_embeddings = item_embeddings size(item_size, dim)
    # return tf.constant_initializer(item_embeddings)
...
def embedding_lookup(input_ids,
    ...
    embedding_table = tf.get_variable(
        ...
        initializer=create_initializer(initializer_range))  # tf.constant_initializer
