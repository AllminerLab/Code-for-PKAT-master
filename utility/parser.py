...
def parse_args():
    parser = argparse.ArgumentParser(description="Run PKAT.")
    ...
    parser.add_argument('--layer_size', nargs='?', default='[64]',  #nargs='?'参数可设置多个
    ...
    parser.add_argument('--model_type', nargs='?', default='PKAT')
